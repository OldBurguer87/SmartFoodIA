...
def test_mutating_http_routes_are_explicitly_classified() -> None:
    allowed = {
        ...
        ("POST", "/api/v1/operations/conversations/{conversation_id}/read"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/release"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/close"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/media"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/customer/addresses"),
        ("PATCH", "/api/v1/operations/conversations/{conversation_id}/customer/addresses/{address_id}"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/orders/{order_id}/cancel"),
        ("POST", "/api/v1/operations/conversations/{conversation_id}/orders/{order_id}/pix/confirm"),
