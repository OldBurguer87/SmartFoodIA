  ...
  return <section className="conversationsConsole">
    <header className="consoleHeader">
      ...
      <div className="consoleControls">
        ...
        <select value={filter} onChange={e => setFilter(e.target.value)}><option value="">Todas</option><option value="OPEN">Olívia</option><option value="HUMAN">Atendente</option><option value="CLOSED">Encerradas</option></select>
